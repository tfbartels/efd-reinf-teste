...
class R2010Service 
{
    ...
    public function getXML(){
        ...
        $std->nfs[1] = new \stdClass();
        $std->nfs[1]->serie = '001'; //Obrigatorio número de série da nota fiscal/fatura ou do Recibo Provisório de Serviço - RPS ou de outro documento fiscal válido.
        $std->nfs[1]->numdocto = '265465'; //Obrigatório Número da nota fiscal/fatura ou outro documento fiscal válido, como Recibo Provisório de Serviço - RPS, CT-e, entre outros.
        $std->nfs[1]->dtemissaonf = '2017-01-22'; //Obrigatório Data de emissão da nota fiscal/fatura ou do Recibo Provisório de Serviço -
                                                    //RPS ou de outro documento fiscal válido.
                            //Validação: O mês/ano informado deve ser igual ao mês/ano indicado no registro de abertura do arquivo.
        $std->nfs[1]->vlrbruto = 200.00; //Obrigatório valor bruto da nota fiscal ou do Recibo Provisório de Serviço - RPS
        $std->nfs[1]->obs = 'observacao pode ser nula'; //Opcional Observações.

        $std->nfs[1]->infotpserv[0] = new \stdClass(); //Obrigatório
